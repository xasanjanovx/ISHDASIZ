...
export function LatestJobsSection({ jobs }: LatestJobsSectionProps) {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden">
      ...
      <div className="absolute top-20 left-[5%] w-[350px] h-[350px] bg-blue-100/30 rounded-full blur-[120px] pointer-events-none animate-float-slow" />
      <div className="absolute bottom-10 right-[8%] w-[300px] h-[300px] bg-teal-100/20 rounded-full blur-[100px] pointer-events-none animate-float-medium" />
